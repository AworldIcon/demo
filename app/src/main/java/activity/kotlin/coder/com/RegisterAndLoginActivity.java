...
import activity.kotlin.coder.com.activity.setting.RegisterActivity;
import activity.kotlin.coder.com.module.SingleConversationActivity;
...
//                            intent.setClass(getApplicationContext(), TypeActivity.class);
                            intent.setClass(getApplicationContext(), SingleConversationActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                            mProgressDialog.dismiss();
